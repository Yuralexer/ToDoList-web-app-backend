...
default_config = json.load(open("config.default.json", "r"))
local_config = json.load(open("config.local.json", "r"))
...
DATABASES = {
    # Вы можете добавить данные БД в config.local.json, 
    # если он установлен на другой хостовой машине
    "default": {
...
CORS_ALLOWED_ORIGINS = local_config["CORS_ALLOWED_ORIGINS"]
